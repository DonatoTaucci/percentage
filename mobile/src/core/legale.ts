/* legale.ts — testo dell'informativa e della nota sull'IA, per l'app.

   È la copia dello stesso documento che sta nel sito (js/legale.js): un
   testo legale che dice due cose diverse nei due client sarebbe peggio di
   nessun testo. La copia non è a occhio — `node scripts/controlla-legale.mjs`
   confronta le due frase per frase e fallisce se si allontanano. */
...
export const AGGIORNATA = '2026-08-11';
export const CONTATTO = 'donatotaucci@gmail.com';

export const INFORMATIVA: Documento = {
...
export const NOTA_IA: Documento = {
...
/** Data dell'ultimo aggiornamento, nella forma lunga della lingua di sistema. */
export function dataLeggibile(): string {
  try {
    return new Date(AGGIORNATA + 'T00:00:00').toLocaleDateString('it-IT', {
